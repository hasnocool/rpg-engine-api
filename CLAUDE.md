...
Unless the user explicitly directs later work, implement the earliest unchecked, unblocked TODO in the active milestone. Do not create a Claude-specific roadmap, parallel TODO, test system, AI architecture, creator architecture or migration model.
