...
Do not create a Claude-specific competing roadmap, creator architecture, testing system, NPC AI, plugin boundary, or migration model. `PLAN.md` controls architecture and `AGENTS.md` controls workflow.
