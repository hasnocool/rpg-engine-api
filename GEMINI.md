...
Do not create a Gemini-specific competing roadmap, creator architecture, testing system, test-evidence protocol, NPC AI, plugin boundary, or migration model. `PLAN.md` controls architecture and `AGENTS.md` controls workflow.
