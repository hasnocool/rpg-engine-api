...
Do not create a separate Gemini-specific architecture or roadmap. If this file and the canonical documents appear to conflict, `PLAN.md` controls architecture and `AGENTS.md` controls agent workflow.
