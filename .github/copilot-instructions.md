...
Do not create a competing roadmap, creator architecture, testing harness, NPC AI, plugin boundary, or migration design.
...
Do not mark roadmap work complete unless its required tests, play scenarios, authoring validation, simulation/reachability checks, and migration evidence are demonstrated where applicable.